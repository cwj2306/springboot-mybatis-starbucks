...
<head>
    ...
    <title>Starbucks Coffee Korea :: write </title>
</head>
<body>
<div class="wrap">
    ...
    <div class="content">
        ...
        <div class="notice_content_title">
            <input class="write_notice_title" name="title" type="text" placeholder="제목을 입력해주세요." />
        </div>
        <div class="notice_content">
            <textarea id="summernote" name="content"></textarea>
        </div>
        <button class="write_button" type="submit">글작성</button>
